...
- [x] 1. Implement Convex2 class basic structure
...
- [x] 2. Implement Convex2 raycast methods
...
- [x] 3. Implement random convex generation
...
- [x] 4. Implement scene initialization and management
  - Files: Code/Game/Gameplay/Game.cpp, Code/Game/Gameplay/Game.hpp
...
- [x] 5. Implement object hover detection and highlighting
  - Files: Code/Game/Gameplay/Game.cpp, Code/Game/Gameplay/Game.hpp
...
- [x] 6. Implement object dragging with sticky focus
  - Files: Code/Game/Gameplay/Game.cpp, Code/Game/Gameplay/Game.hpp
...
- [x] 7. Implement object rotation and scaling
  - Files: Code/Game/Gameplay/Game.cpp, Code/Game/Gameplay/Game.hpp
...
- [x] 8. Implement scene control keyboard shortcuts
  - Files: Code/Game/Gameplay/Game.cpp, Code/Game/Gameplay/Game.hpp
...
- [x] 9. Implement basic convex rendering with two modes
  - Files: Code/Game/Gameplay/Game.cpp, Code/Game/Gameplay/Game.hpp
